//===-- Implementation header for process_vm_writev ------------*- C++ -*-===//
//
...
#ifndef LLVM_LIBC_SRC_SYS_UIO_PROCESS_VM_WRITEV_H
#define LLVM_LIBC_SRC_SYS_UIO_PROCESS_VM_WRITEV_H
...
#endif // LLVM_LIBC_SRC_SYS_UIO_PROCESS_VM_WRITEV_H
