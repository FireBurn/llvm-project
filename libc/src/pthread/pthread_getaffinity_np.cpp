...
// Reports which processors a thread may run on. The kernel knows a thread by
// its id, so that is what the pthread_t is turned into. Unlike the sched calls
